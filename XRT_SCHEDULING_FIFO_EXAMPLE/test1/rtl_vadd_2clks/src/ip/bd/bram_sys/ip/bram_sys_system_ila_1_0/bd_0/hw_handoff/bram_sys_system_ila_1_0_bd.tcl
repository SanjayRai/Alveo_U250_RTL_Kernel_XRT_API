...
################################################################
# This is a generated script based on design: bd_5560
#
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXI] [get_bd_intf_pins g_inst/slot_0_axi]
  ...
  connect_bd_net -net net_slot_0_axi_ar_ctrl [get_bd_pins ila_lib/probe12] [get_bd_pins slot_0_ar/dout]
  ...
  connect_bd_net -net net_slot_0_axi_aw_ctrl [get_bd_pins ila_lib/probe9] [get_bd_pins slot_0_aw/dout]
  ...
  connect_bd_net -net net_slot_0_axi_b_ctrl [get_bd_pins ila_lib/probe11] [get_bd_pins slot_0_b/dout]
  ...
  connect_bd_net -net net_slot_0_axi_r_ctrl [get_bd_pins ila_lib/probe13] [get_bd_pins slot_0_r/dout]
  ...
  connect_bd_net -net net_slot_0_axi_w_ctrl [get_bd_pins ila_lib/probe10] [get_bd_pins slot_0_w/dout]
  ...
  connect_bd_net -net net_slot_0_axi_wstrb [get_bd_pins g_inst/m_slot_0_axi_wstrb] [get_bd_pins ila_lib/probe8]
